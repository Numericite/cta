<template>
  <div class="pt-24 px-10 mx-0 lg:px-0 xl:px-0 xl:pt-32 flex flex-col">
    <div class="flex ml-6 xl:ml-0 pb-6 xl:pb-12 items-center w-full relative">
      <button class="absolute ml-3 xl:ml-0 back-btn rounded-full w-8 h-8 bg-ms-blue-dark fill-current text-white flex items-center justify-center" @click="$router.push('/dashboard/college/operator/eleves')">
