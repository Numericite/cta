  ...
  <div class="pt-24 flex flex-col px-10 xl:px-0">
    <div class="flex flex-row">
      ...
      <div class="flex flex-col justify-center pl-6">
        ...
        <div class="pt-5 ms-description text-ms-gray-dark">{{ $store.state.auth.user.classroom.name }} — {{ $store.state.auth.user.school.name }}</div>
      </div>
    </div>
    <div class="flex flex-row">
      <div class="w-2/3">
        ...
        <div class="pt-4 flex">
          ...
          <FormulateInput v-model="user.lastName" :outerClass="['w-1/2 my-8 pl-6']" :inputClass="['mt-8 py-5 px-6 focus:border-purple text-ms-gray-dark']" label="Nom" type="text" placeholder="Nom..."/>
        </div>
        <div class="flex">
          <FormulateInput v-model="user.email" :outerClass="['w-full my-8']" :inputClass="['mt-8 py-5 px-6 focus:border-purple text-ms-gray-dark']" label="Email" type="text" disabled/>
        </div>
...
<script>
  ...
  export default {
    name: 'CollegeStudentDashboardProfil',
