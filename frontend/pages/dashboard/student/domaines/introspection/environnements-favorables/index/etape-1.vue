  ...
  <div class="activity__right relative min-h-screen bg-blue-lightest xl:w-3/5 w-full pb-12 pt-6 xl:pl-16 px-6 xl:pr-32 flex flex-col justify-center h-auto">
    ...
    <div class="mt-6 flex">
      ...
      <h1 class="title text-blue font-bold text-3xl leading-normal xl:mt-4 sm:text-xl">
        Quelle est la taille de la structure que tu souhaites intégrer ?
      </h1>
    </div>
    <!-- End Title -->
...
export default {
  ...
  created() {
    this.choices = this.actions.filter(function(action) {
      return action.selection_id === '1689ccba-0283-48d8-9ea2-99e2559064a7'
    })
  ...
  methods: {
    nextPage() {
      ...
      this.$router.push( '/dashboard/student/domaines/introspection/environnements-favorables/etape-2' )
    }
  }
}
</script>
