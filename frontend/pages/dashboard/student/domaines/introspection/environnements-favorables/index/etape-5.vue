<template>
  <div class="activity__right relative min-h-screen bg-blue-lightest xl:w-3/5 w-full pb-12 pt-6 xl:pl-16 px-6 xl:pr-32 flex flex-col justify-center h-auto">
    ...
    <!-- Title -->
    <div class="mt-6 flex">
      <span class="text-blue-lighter font-bold text-6xl mr-4 sm:text-3xl">5.</span>
...
export default {
  ...
  created() {
    this.choices = this.actions.filter(function(action) {
      return action.selection_id === 'b45d87c4-ac27-4685-9b3f-2178053b9a71'
    })
  ...
  methods: {
    nextPage() {
      ...
      this.$router.push( '/dashboard/student/domaines/introspection/environnements-favorables/etape-6' )
    }
  }
}
</script>
